...
const Cover = () => {
    return (
        <div className="mx-auto h-full lg:max-w-screen-xl">
            <div className="flex flex-col lg:flex-row">
                <div className="w-full lg:w-1/2 animate__animated animate__backInRight">
                    ...
                    <Image src={AvatarImage} alt={'avatar'} width={80} height={80} className="w-80 h-80 mx-auto"/>
                    <Skills />
                </div>
                <div
                    className="w-full lg:w-1/2 flex flex-col animate__animated animate__backInLeft pb-20"
                >
                    <h1
                        className="text-center text-3xl xl:text-5xl mx-auto xl:mt-10 font-bold text-gray-700 dark:text-gray-100"
                    >
